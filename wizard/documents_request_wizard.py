...
class RequestWizard(models.TransientModel):
    ...
    activity_type_id = fields.Many2one('mail.activity.type',
                                       ...
                                       default=lambda self: self.env.ref('dmmsys_document_common.mail_documents_activity_data_md',
    ...
    def request_document(self):
        ...
        request_template = self.env.ref('dmmsys_document_common.mail_template_document_request', raise_if_not_found=False)
        if request_template:
