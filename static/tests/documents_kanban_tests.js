...
import { DocumentsKanbanRenderer } from "@dmmsys_document_common/views/kanban/documents_kanban_renderer";
import {
        ...
        function () {
            ...
            QUnit.skip("can Request a file", async function (assert) {
                ...
                patchWithCleanup(kanban.env.services.action, {
                    doAction(action) {
                        assert.deepEqual(
                            action,
                            "dmmsys_document_common.action_request_form",
                            "should open the url form"
                        );
                    },
                });
            ...
            QUnit.skip("SearchPanel: can edit folders", async function (assert) {
                ...
                patchUserWithCleanup({
                    hasGroup: (group) => group === "dmmsys_document_common.group_documents_manager",
                });
